...
CONTROL_DIR="$ROOT_DIR/nexus_control_server"
START_SCRIPT="$CONTROL_DIR/scripts/nexus_start.sh"
...
SERVER_PATTERN="python3 nexus_control_server/server.py"
TUNNEL_PATTERN="nexus_control_server/bin/cloudflared tunnel --url http://127.0.0.1:8787 --no-autoupdate"
